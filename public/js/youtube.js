...
reach.youtube = {
  ...
  getUser: function()
  {
                var $url = '//gdata.youtube.com/feeds/api/users/therealjustivy?alt=json';
                ...
                $.ajax({
                    ...
                    success: function(data) {
                      ...
                      total_page_impresions =  data.entry.yt$statistics.totalUploadViews;
                     
                      $('#keyMetrics .youtube').find('.totalbox').html(reach.visuals.roundlarge(total_page_impresions));
...
(function() {
  ...
  // See //code.google.com/p/google-api-javascript-client/wiki/Authentication
  ...
  // //code.google.com/p/google-api-javascript-client/wiki/GettingStarted#Loading_the_Client
