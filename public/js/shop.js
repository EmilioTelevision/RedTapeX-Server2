$(function() {
  ...
  */
    ...
    if (orders.length > 0) {
      ...
      $.ajax({
        ...
        success: function() {
          ...
          $messageTitle.text('Your Order is Complete');
  ...
  function addLoadingIcon(element) {
    ...
    return null; //new Spinner(opts).spin(element);
  }
  ...
  $addcart.on('click', function()
  {
     ...
     console.log($this.data());
        ...
        addItem({
          name: $this.data('name'),
          price:Number($this.data('price').replace(/[^0-9\.]+/g,"")),
          size: 'm',
          quantity: 1,
          color: 'G'
        });
